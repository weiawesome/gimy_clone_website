    ...
    return(
        <div>
            ...
            <div className={"p-3 flex flex-row"}>
                <Image alt={"image"} width={200} height={250} className={"shadow-lg rounded-lg overflow-hidden lg:w-auto lg:h-72"} src={loadError?"/icon.png":filmInformation?.resource} onError={()=>{setLoadError(true)}}/>
