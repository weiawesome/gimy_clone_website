...
const TvSeriesPage:React.FC<AllFilmListProps>=({serviceUrl,typeList,categoryList})=>{
        ...
        <main>
            ...
            { (category!==undefined || location!==undefined || releaseYear!==undefined) &&(
                <div className={"flex flex-col"}>
                    ...
                    <FilterContent service_url={serviceUrl} film_type={TvSeriesTypeInformation.QUERY_TYPE} category={category} location={location} release_year={releaseYear} order_type={orderType} page={page===undefined?1:Number(page)}></FilterContent>
                </div>
            )}
            <Footer></Footer>
        </main>
